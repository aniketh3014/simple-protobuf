...
type Laptop struct {
	...
	PriceRs   float32                `protobuf:"fixed32,12,opt,name=price_rs,json=priceRs,proto3" json:"price_rs,omitempty"`
	Year      uint32                 `protobuf:"varint,13,opt,name=year,proto3" json:"year,omitempty"`
...
func (x *Laptop) GetKg() float32 {
	if x, ok := x.GetWeight().(*Laptop_Kg); ok {
		return x.Kg
	}
	return 0
}

func (x *Laptop) GetLb() float32 {
	if x, ok := x.GetWeight().(*Laptop_Lb); ok {
		return x.Lb
	}
	return 0
}

func (x *Laptop) GetPriceRs() float32 {
	if x != nil {
		return x.PriceRs
	}
	return 0
...
type Laptop_Kg struct {
	Kg float32 `protobuf:"fixed32,10,opt,name=kg,proto3,oneof"`
}

type Laptop_Lb struct {
	Lb float32 `protobuf:"fixed32,11,opt,name=lb,proto3,oneof"`
}

func (*Laptop_Kg) isLaptop_Weight() {}

func (*Laptop_Lb) isLaptop_Weight() {}
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x97, 0x03, 0x0a, 0x06,
	...
	0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x16, 0x0a, 0x03, 0x67, 0x70, 0x75,
	0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x04, 0x2e, 0x47, 0x50, 0x55, 0x52, 0x03, 0x67, 0x70,
	0x75, 0x12, 0x22, 0x0a, 0x07, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x18, 0x07, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x08, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x52, 0x07, 0x73, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x1f, 0x0a, 0x06, 0x73, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x18,
	...
	0x61, 0x72, 0x64, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x12, 0x10, 0x0a,
	0x02, 0x6b, 0x67, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x02, 0x48, 0x00, 0x52, 0x02, 0x6b, 0x67, 0x12,
	0x10, 0x0a, 0x02, 0x6c, 0x62, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x02, 0x48, 0x00, 0x52, 0x02, 0x6c,
	0x62, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x72, 0x73, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x02, 0x52, 0x07, 0x70, 0x72, 0x69, 0x63, 0x65, 0x52, 0x73, 0x12, 0x12, 0x0a, 0x04,
	0x79, 0x65, 0x61, 0x72, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x79, 0x65, 0x61, 0x72,
	...
	0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b, 0x6d, 0x65, 0x73, 0x73, 0x61,
